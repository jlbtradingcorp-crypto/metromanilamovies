...
export default function Home() {
  ...
  return <main>
    <nav><a className="logo" href="#top"><span>MM</span>movie metro</a><div className="navlinks"><a href="#showing">Now showing</a><a href="#cinemas">Cinemas</a><a href="#guide">Movie guide</a><a href="#contact">Contact</a></div><button className="location">⌖ {area === "All Metro Manila" ? "Metro Manila" : area}</button><button className="save-count">♡ <b>{saved.length}</b></button></nav>
    ...
    <section className="contact-section" id="contact"><div><p className="kicker">STAY IN THE LOOP</p><h2>Know a listing we should check?</h2><p>Send an official cinema link, correction, or partnership note. Every message is reviewed before anything is published.</p><a className="whatsapp" href="https://wa.me/639940851047" target="_blank" rel="noreferrer">Message us on WhatsApp ↗</a></div><ContactForm /></section>
